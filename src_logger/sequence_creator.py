...
def create_sequences(data, lookback):
    try:
        ...
        logger.debug("Created sequences for model training")
...
def prepare_data():
    ...
    '''
        ...
        logger.debug("Splitted data into X_train,X_test,y_train,y_test,scaler")
        return X_train,X_test,y_train,y_test,scaler
    

    except Exception as e:
        logger.exception("Error occured while splitting data for X_train,X_test,y_train,y_test,scaler")
        raise